...
function BleachDetan() {
  const bleachDetanItems = [
    {
      image: image1,
      title: "Card Title 1",
  ...
  return (
    <>
      <h1 className="card-items-heading">All bleach & Detan items</h1>
      <div className="card-container">
        {bleachDetanItems.map((item, index) => (
          <ServiceCard
            key={index}
            image={item.image}
            title={item.title}
